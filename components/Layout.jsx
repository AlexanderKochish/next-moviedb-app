...
const Layout = ({ children, trending }) => {
  ...
  return (
    <div
      className={`relative w-full h-screen top-0 left-0 lg:min-h-[140vh] bg-gradient-to-b scrollbar from-black/10 to-black ${
        !open && "!h-screen"
      }`}
    >
      <Head>
      ...
      <main className="w-full min-h-screen">
        ...
        <section className="-mt-24 pl-8">{children}</section>
      </main>
