  ...
  return (
    <div className="w-full min-h-screen flex flex-col justify-center ">
      <div className="w-full h-screen absolute top-0 left-0 -z-10 ">
        <Image
          src={`${img_origin}${movie?.backdrop_path || movie?.poster_path}`}
          alt="banner"
          fill
      ...
      <div className="text-white mt-40 mb-48 space-y-2 md:space-y-4 px-5">
        <h2 className="text-3xl font-semibold text-shadow-lg sm:text-4xl lg:text-6xl">
          {movie?.title || movie?.original_title || movie?.name}
        </h2>
        <p className="text-shadow-lg md:text-1xl lg:text-2xl overflow-y-scroll scrollbar">
          {movie?.overview}
        </p>
        ...
        <div className="space-x-2 space-y-2">
          <button
            ...
            className="bg-rose-700 py-2 px-6 inline-flex items-center rounded-xl"
          >
          ...
          <button
            ...
            className="bg-gray-500 py-2 px-6 inline-flex items-center rounded-xl"
          >
